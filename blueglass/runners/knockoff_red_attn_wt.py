...
class KnockOffRedAttnWtRunner(SAERunner):
    def __init__(self, conf: BLUEGLASSConf):
        ...
        self.column_knockoff_indices = None
    ...
    def sae_decoder_column_rank(self) -> None:
        ...
        for name, sae in model.eval().sae_per_name.items():
            ...
            records[name] = fig
            column_knockoff_indices[name] = _cluster_indices
            plt.close(fig)
        self.column_knockoff_indices = column_knockoff_indices
