...
class DecoderClusterRunner(SAERunner):
    ...
    def run_step(self) -> Dict[str, Any]:
        ...
        """
        self.model = copy.deepcopy(self.vanilla_sae_model)

        self.model = self.sae_decoder_cluster_knockoff()
    ...
    def infer(self) -> Dict[str, Any]:
        ...
        for self.step in zip(range(1, self.max_steps + 1)):
    ...
    def sae_decoder_cluster_knockoff(self) -> None:
        ...
        for name, sae in model.eval().sae_per_name.items():
            ...
            records[name] = fig
            cluster_indices[name] = _cluster_indices
            plt.close(fig)
        return records
