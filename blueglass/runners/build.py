...
from .knockoff_columns import KnockoffColumns
from .sae_knockoff import SaeKnockoff
...
def build_runner(conf: BLUEGLASSConf) -> Runner:
    runner_classes = {
        ...
        RunnerType.KNOCKOFF_LAYER: KnockoffColumns,
        RunnerType.SAE_KNOCKOFF: SaeKnockoff,
    }
