...
def evaluate(
    ...
    pkl_path = os.path.join(
        results_path,
        "ignore={}_difficulty={}_evaltype={}.pkl".format(
            ignore_other_vru, difficulty, eval_type
        ),
    )
    ...
    mr_fppi = MrFppi(result=result)
    title = "difficulty={}, ignore_other_vru={}, evaltype={}".format(
        difficulty, ignore_other_vru, eval_type
    )
    label = "lamr: {}".format(mr_fppi.log_avg_mr_reference_implementation())
    fig = mr_fppi.create_plot(title, label)
    filename = "lamr_ignore={}_difficulty={}_evaltype={}".format(
        ignore_other_vru, difficulty, eval_type
    )
