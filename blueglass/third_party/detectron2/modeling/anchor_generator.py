...
from blueglass.third_party.detectron2.layers import ShapeSpec, move_device_like
from blueglass.third_party.detectron2.structures import Boxes, RotatedBoxes
