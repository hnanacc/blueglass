...
def collect_env_info():
    ...
    try:
        import blueglass.third_party.detectron2  # noqa
    ...
    try:
        import blueglass.third_party.detectron2._C as _C
...
def main() -> None:
    global x
    try:
        from blueglass.third_party.detectron2.utils.collect_env import (
