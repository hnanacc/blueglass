...
def all_reduce(input_tensor, reduce_op: Literal["mean", "sum"] = "sum"):
    """
    Reduce the values in the dictionary from all processes
    so that all processes have reduced results.

    Args:
        input (Tensor): inputs to be reduced. Values must be scalar CUDA Tensor.
