...
from blueglass.third_party.detectron2.layers import ShapeSpec, cat
from blueglass.third_party.detectron2.layers.roi_align_rotated import ROIAlignRotated
from blueglass.third_party.detectron2.modeling import poolers
from blueglass.third_party.detectron2.modeling.proposal_generator import rpn
from blueglass.third_party.detectron2.modeling.roi_heads.mask_head import (
    mask_rcnn_inference,
)
from blueglass.third_party.detectron2.structures import (
    Boxes,
    ImageList,
    Instances,
    Keypoints,
