...
from blueglass.third_party.detectron2.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from blueglass.third_party.detectron2.config import instantiate, LazyCall
