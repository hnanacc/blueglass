...
import blueglass.third_party.detectron2.utils.comm as comm
from blueglass.third_party.detectron2.config import CfgNode
from blueglass.third_party.detectron2.data import MetadataCatalog
from blueglass.third_party.detectron2.data.datasets.coco import convert_to_coco_json
from blueglass.third_party.detectron2.structures import Boxes, BoxMode, pairwise_iou
...
try:
    from blueglass.third_party.detectron2.evaluation.fast_eval_api import COCOeval_opt
except ImportError:
...
class COCOEvaluator(DatasetEvaluator):
        ...
        *,
        ...
        Args:
            ...
            allow_cached_coco (bool): Whether to use cached coco json from previous validation
                ...
                Defaults to True.
        """
        self._logger = setup_blueglass_logger(__name__)
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        """
        # we need AR scores returned as well.
        metrics = {
            "bbox": [
                "AP",
                "AP50",
        ...
        # we don't need per class AP returned.
